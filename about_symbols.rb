...
class AboutSymbols < Neo::Koan
  ...
  # Symbols can only exist in one place at a time, we can't convert to a symbol first and then
  # compare with a string since that would 'clutter' up the symbol space and make it so that we could only have one
  ...
  def test_symbols_do_not_have_string_methods
    ...
    #  symbols AREN'T strings, they don't have the string methods defined on them, do respond.to? returns
  end
