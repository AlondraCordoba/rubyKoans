...
class AboutMessagePassing < Neo::Koan
  ...
  def test_methods_can_be_invoked_more_dynamically
    ...
    assert mc.send("caught?")
    assert mc.send("caught" + "?" )    # What do you need to add to the first string? Missing the question mark
    assert mc.send("CAUGHT?".downcase )      # What would you need to do to the string? It downcase like the original, not uppercase
  end
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # In this case, the method is already defined as something else?
  end
  ...
  def test_calling_method_missing_causes_the_no_method_error
    ...
    # Then we wouldn't have the NoMethodError, as there would be a defined method
    #
    # NOTE:
    #
  ...
  def test_foo_method_are_caught
    ...
    assert_equal catcher.foo_baz, catcher.foo_baz
  end
