...
class AboutClasses < Neo::Koan
  ...
  def test_instances_of_classes_can_be_created_with_new
    fido = Dog.new #=> #<Dog:0x0000021cffdf3608>
  ...
  def test_instance_variables_can_be_set_by_assigning_to_them
    # The .instance_variables method on a class returns an array of all the declared instance variables
    fido = Dog2.new # => #<Dog2:0x0000021cffd31850>
  ...
  def test_instance_variables_cannot_be_accessed_outside_the_class
    fido = Dog2.new # => #<Dog2:0x0000021cffd01a10>
    fido.set_name("Fido")
  ...
  def test_initialize_provides_initial_values_for_instance_variables
    fido = Dog6.new("Fido") # => #<Dog6:0x0000021cffda4620 @name="Fido">
    assert_equal "Fido", fido.name
  end
  ...
  def test_different_objects_have_different_instance_variables
    fido = Dog6.new("Fido") # => #<Dog6:0x0000021cffcd9718 @name="Fido">
    rover = Dog6.new("Rover") # => #<Dog6:0x0000021cffdf0840 @name="Rover">
  ...
  def test_to_s_provides_a_string_version_of_the_object
    fido = Dog7.new("Fido") # => <Dog named 'Fido'>
