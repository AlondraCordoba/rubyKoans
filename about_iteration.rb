...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # It combines all the elements, 
    # applies the block result + element. to each item in the array.
    # For the next item ("element"), the value returned from the block is "result". 
    # The way you've called it (with a parameter), "result" starts with the value 
    # of that parameter. So the effect is adding the elements up.
